...
let
  sources = {
    ...
    "jsdom-11.7.0" = {
      ...
      version = "11.7.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/jsdom/-/jsdom-11.7.0.tgz";
        sha512 = "2rqf7fd5falvcp2dhdz70aaggn1ak928kwwl2pkrd014zdxivc50ibqpij6k255q6n7sbv00zakdfnfajq3va4blxyh7qikh9rx5p7l";
      };
    };
    "jsdom-7.2.2" = {
      name = "jsdom";
